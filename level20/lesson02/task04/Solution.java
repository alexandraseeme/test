...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            classWithStatic.staticString = "this is for TEST";
            classWithStatic.i = 3;
            classWithStatic.j = 4;
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            String staticStringNotEmpty = staticString != null ? "yes" : "no";
            printWriter.println(staticStringNotEmpty);
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            String staticStringNotEmpty = reader.readLine();
            if (staticStringNotEmpty.equals("yes"))
